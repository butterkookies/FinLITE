...
async function run() {
  try {
    // Figma requires loading the exact default font (Inter Regular) before modifying any text
    ...
    connect(entStudents, sys0, "Tournament and event registration fees");
    ...
    connect(entOfficers, sys0, "Official receipts and expense slips");
    ...
    console.error("FinLITE Plugin Error:", err);
